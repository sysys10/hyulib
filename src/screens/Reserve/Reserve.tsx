...
import { StyleSheet, View, Platform, SafeAreaView, Pressable } from 'react-native';
            ...
            <View style={styles.container}>
                <View style={styles.cardContainer}>
                    <CampusCard
                        ...
                        name="ERICA 캠퍼스"
                        onPress={() => navigation.navigate('ReservationDetail', { campus: 'erica' })}

                    />
                    <CampusCard
                        image={require('@/assets/images/seoul.jpg')}
                        name="서울 캠퍼스"
                        onPress={() => navigation.navigate('ReservationDetail', { campus: 'seoul' })}

                    />
                </View>

                <View>
                    <Pressable style={styles.red}>
                        <CustomText variant='primary' type='body' weight='semiBold'>버튼</CustomText>
                    </Pressable>
...
const customStyle = (theme: ThemeProp) => {
    return StyleSheet.create({
        red: {
            ...
            borderColor: colors[theme].bg_button_focus,
            borderRadius: 8,
            alignItems: 'center'
        },
        container: {
